...
abstract class SyncListItemOptions
{
    ...
    /**
     * @param string $ifMatch If provided, applies this mutation if (and only if) the â€œrevisionâ€ field of this [map item] matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
...
class DeleteSyncListItemOptions extends Options
    ...
    /**
     * If provided, applies this mutation if (and only if) the â€œrevisionâ€ field of this [map item] matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     *
     * @param string $ifMatch If provided, applies this mutation if (and only if) the â€œrevisionâ€ field of this [map item] matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     * @return $this Fluent Builder
     */
