...
abstract class PortingPortInModels
{
    ...
    */
     ...
     * @property string $state The state name, ex: CA or California. Note this should match the losing carrierâ€™s information exactly. So if they spell out the entire stateâ€™s name instead of abbreviating it, please do so.
    ...
    */
     ...
     * @property \DateTime|null $targetPortInDate Target date to port the number. We cannot guarantee that this date will be honored by the other carriers, please work with Ops to get a confirmation of the firm order commitment (FOC) date. Expected format is ISO Local Date, example: â€˜2011-12-03`. This date must be at least 7 days in the future for US ports and 10 days in the future for Japanese ports. We can't guarantee the exact date and time, as this depends on the losing carrier
     * @property string|null $targetPortInTimeRangeStart The earliest time that the port should occur on the target port in date. Expected format is ISO Offset Time, example: â€˜10:15:00-08:00'. We can't guarantee the exact date and time, as this depends on the losing carrier
     * @property string|null $targetPortInTimeRangeEnd The latest time that the port should occur on the target port in date. Expected format is ISO Offset Time, example: â€˜10:15:00-08:00'. We can't guarantee the exact date and time, as this depends on the losing carrier
